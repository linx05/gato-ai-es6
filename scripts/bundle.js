	...
	var control = function () {
	    ...
	    _createClass(control, [{
	        ...
	        value: function setupPlayer() {
	            (0, _jquery2.default)(".player").click(function () {
	                var $this = (0, _jquery2.default)(this);
	                (0, _jquery2.default)(".player").not($this).removeClass("selected").addClass("not-selected");
	                $this.removeClass("not-selected").addClass("selected");
	            });
	        }
	    }, {
	        key: "setupStart",
	        value: function setupStart() {
	            (0, _jquery2.default)(".start").click(function (x) {
	                var player = (0, _jquery2.default)(".player.selected").attr("id");
	                if (player) {
	                    var aiPlayer = new _ai2.default();
	                    var uiInstance = new _Ui2.default();
	                    var game = new _game2.default(aiPlayer, uiInstance, player);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _aiAction = __webpack_require__(4);

	var _aiAction2 = _interopRequireDefault(_aiAction);
	...
	var AI = function () {
	    ...
	    _createClass(AI, [{
	        key: "makeRandomMove",
	        value: function makeRandomMove(turn) {
	            var available = this.game.currentState.emptyCells();
	            var randomCell = available[Math.floor(Math.random() * available.length)];
	            var action = new _aiAction2.default(randomCell);
	        ...
	        key: "notify",
	        value: function notify(turn, callback) {
	            var indx = this.makeRandomMove(turn);
	            callback(indx);
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AiAction = function () {
	    ...
	    _createClass(AiAction, [{
	        key: "applyTo",
	        value: function applyTo(state) {
	            var next = new _state2.default(state);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	    function Game(ai, ui, player) {
	        ...
	        this.currentState = new _state2.default();
	    ...
	    _createClass(Game, [{
	        key: "advanceTo",
	        value: function advanceTo(state) {
	            var _this = this;
	            ...
	            if (state.isTerminal()) {
	                ...
	                if (state.result === "X-won")
	                    //X won
	                    this.ui.switchViewTo("won");else if (state.result === "O-won")
	                    //X lost
	                    this.ui.switchViewTo("lost");else
	                    //draw
	                ...
	                if (this.currentState.turn === "X") {
	                    ...
	                    this.ui.humanMove(function (indx) {
	                        return _this.makeAMove(indx);
	                    });
	                } else {
	                    this.ui.switchViewTo("robot");

	                    this.ai.notify(this.turn, function (indx) {
	                        return _this.makeAMove(indx);
	                    });
	                }
	            }
	        ...
	        key: "makeAMove",
	        value: function makeAMove(indx) {
	            var next = new _state2.default(this.currentState);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Ui = function () {
	    ...
	    _createClass(Ui, [{
	        key: "showCurrentView",
	        value: function showCurrentView(turn) {
	            this.currentView = "#" + turn;
	            $(this.currentView).fadeIn("fast");
	        }
	    }, {
	        key: "switchViewTo",
	        value: function switchViewTo(turn) {
	            var _this = this;
	            ...
	            if (this.intialControlsVisible) {
	                ...
	                $(".initial").fadeOut({
	                    duration: "fast",
	                        ...
	                        return _this.showCurrentView(turn);
	                    }
	                });
	            } else {
	        ...
	        key: "insertAt",
	        value: function insertAt(indx, symbol) {
	            var board = $(".cell");
	            var cell = $(board[indx]);
	        ...
	        key: "humanMove",
	        value: function humanMove(callback) {
	        ...
	        key: "restartGame",
	        value: function restartGame(newGame) {
	            var board = $('.cell');
